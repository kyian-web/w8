...
var bodyCar = document.querySelectorAll('.choice-form__body-img'),
    bodyCarActive = document.querySelectorAll('.choice-form__body-img .check');
bodyCar.forEach(function (item, i) {
  item.addEventListener('click', function (e) {
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var arrow = document.querySelectorAll('.select__icon'),
    ...
    list.forEach(function (list) {
      ...
      arrow.forEach(function (item) {
        if (list.classList.contains('show')) {
          item.style.transform = 'rotate(-180deg)'; // arrow.style.marginTop = '10px';
        } else {
          item.style.transform = 'rotate(0deg)'; // arrow.style.marginTop = '10px';
        }
      });
    });
  }
  ...
  listItem.forEach(function (item, i) {
    item.addEventListener('click', function (e) {
      var srcIcon = e.target.getAttribute('src');
      selectWindow.forEach(function (window) {
        window.src = srcIcon;
      });
      togglerList();
      inputPhone.forEach(function (input, j) {
